        ...
        <section className="min-h-screen flex items-center justify-center">
            <Row className="bg-gray-100 flex rounded-2xl shadow-lg max-w-3xl p-5 items-center">
                <Col md={12} className="px-8 md:px-16">
                    <Title className="font-bold text-2xl text-[#002D74]">Register</Title>
                    <Paragraph className="text-xs mt-4 text-[#002D74]">Daftarkan diri anda untuk menikmati layanan kami</Paragraph>
                    ...
                    <Form action="" className="flex flex-col gap-4">
                        ...
                        <div className="relative">
                            <Input className="p-2 rounded-xl border w-full" type="password" name="password" placeholder="Confirm Password"/>
                            <EyeFilled className="text-lg text-blue-700 absolute top-1/2 right-3 -translate-y-1/2" />
                        </div>
                    ...
                    <div className="mt-3 text-xs flex justify-between items-center text-[#002D74]">
                        <Paragraph>Sudah punya akun?</Paragraph>
                        <Button onClick={()=>navigate('/auth/login')} className="py-2 px-5 bg-white border rounded-xl hover:scale-110 duration-300">Login</Button>
                    </div>
                </Col>
